...
namespace he{
	 ...
	 *	@param	count	The number of vertices passed.
	 *	@param	vert		Array of GLKVector2 per-filled with object space coordinates that will be replaced with world space coordinates.
	 */
