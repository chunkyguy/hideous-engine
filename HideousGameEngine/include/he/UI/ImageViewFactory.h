...
namespace he {
	...
	public:
		 ...
		 */
		ImageViewFactory(TextureShader *shder, TextureAtlas *atlas_m = nullptr, Texture *texture_m = nullptr);
		
		/** Create with atlas */
		ImageViewFactory(TextureShader *shder, const std::string &data_path, const std::string &img_path, TextureAtlas::AtlasFormat format);
		
		/** Create with texture */
		ImageViewFactory(TextureShader *shder, const std::string &img_path);
