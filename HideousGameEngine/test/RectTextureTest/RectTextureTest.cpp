...
void RectTextureTest::load_textures(){
	...
	for(int i = 0; i < 2; ++i){
		...
		he::RenderObject *r3 = new he::RenderObject(v, shader_, atlas_->GetTexture(), mvpMat);
	...
	tMat = GLKMatrix4MakeTranslation(pos.x, pos.y, -0.1);
	mvpMat = GLKMatrix4Multiply(he::g_Screen->projection_, tMat);
	he::RenderObject *r4 = new he::RenderObject(v, shader_, atlas_->GetTexture(), mvpMat);
	...
	tMat = GLKMatrix4MakeTranslation(pos.x, pos.y, -0.1);
	mvpMat = GLKMatrix4Multiply(he::g_Screen->projection_, tMat);
	he::RenderObject *r5 = new he::RenderObject(v, shader_, atlas_->GetTexture(), mvpMat);
